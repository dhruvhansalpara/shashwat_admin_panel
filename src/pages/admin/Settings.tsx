...
export function SettingsPage({ settings, onUpdate }: SettingsPageProps) {
  ...
  return (
    <motion.div 
      ...
      initial="hidden"
      animate="show"
      className="space-y-12 pb-20 font-display"
    >
      <motion.div variants={item} className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
        <div>
          <h2 className="text-5xl font-black tracking-tighter text-slate-800 uppercase font-display leading-none italic">Site Settings</h2>
          <p className="text-[#009688] mt-2 font-black uppercase tracking-[0.4em] text-[10px] pl-0.5 opacity-100">Manage website identity, contact details, and technical settings</p>
        </div>
      </motion.div>
      ...
      <Tabs defaultValue="general" className="w-full">
        ...
        <AnimatePresence mode="wait">
          <TabsContent key="general" value="general" className="max-w-4xl space-y-10 focus-visible:outline-none">
            <motion.div 
              ...
              <Card className="border-2 border-slate-50 shadow-[0_8px_40px_rgba(0,0,0,0.02)] rounded-[32px] overflow-hidden bg-white">
                <CardHeader className="p-12 pb-6 border-b border-slate-50">
                  <div className="flex items-center gap-6 mb-2">
                    ...
                    <div>
                      <CardTitle className="text-3xl font-black tracking-tighter text-slate-800 uppercase leading-none">Website Identity</CardTitle>
                      <CardDescription className="font-bold text-slate-400 uppercase text-[10px] tracking-widest mt-2">Manage your company name and display details.</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="p-12 pt-10 space-y-10">
                  <div className="space-y-3">
                    <Label htmlFor="site_name" className="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Website Display Name</Label>
                    <Input 
                      id="site_name" 
              ...
              <Card className="border-2 border-slate-50 shadow-[0_8px_40px_rgba(0,0,0,0.02)] rounded-[32px] overflow-hidden bg-white">
                <CardHeader className="p-12 pb-6 border-b border-slate-50">
                  <div className="flex items-center gap-6 mb-2">
                    ...
                    <div>
                      <CardTitle className="text-3xl font-black tracking-tighter text-slate-800 uppercase leading-none">WhatsApp Settings</CardTitle>
                      <CardDescription className="font-bold text-slate-400 uppercase text-[10px] tracking-widest mt-2">Set where guests will reach you on WhatsApp.</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="p-12 pt-10 space-y-10">
                  <div className="space-y-4">
                    <Label htmlFor="whatsapp" className="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">WhatsApp Business Number</Label>
                  ...
                  <div className="space-y-4">
                    <Label htmlFor="message" className="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Pre-filled Chat Message</Label>
                    <Textarea 
                      id="message" 
                  ...
                  <div className="p-10 rounded-[32px] border-2 bg-emerald-50/20 border-emerald-500/5 flex flex-col md:flex-row gap-10">
                    ...
                    <div className="space-y-6 flex-1 min-w-0">
                      <div className="space-y-2">
                        <p className="text-[10px] font-black uppercase tracking-[0.2em] text-emerald-800">Your WhatsApp Link</p>
                      ...
                      <Button size="sm" variant="outline" asChild className="h-12 px-10 rounded-2xl text-[10px] font-black uppercase tracking-[0.3em] bg-[#009688] border-none text-white hover:bg-[#00796b] transition-all hover:scale-105 active:scale-95 shadow-lg shadow-[#009688]/20">
                        <a href={previewLink} target="_blank" rel="noopener noreferrer">Test Chat Link</a>
                      </Button>
                    </div>
                  </div>
                </CardContent>
                <div className="p-12 pt-0 flex justify-end">
                  <Button onClick={handleSave} className="rounded-2xl h-16 px-12 bg-slate-800 hover:bg-slate-900 text-white font-black text-[12px] uppercase tracking-[0.2em] shadow-xl shadow-slate-200/50 transition-all hover:scale-[1.02]">
                    <Save className="w-5 h-5 mr-3" strokeWidth={3} /> Save Website Settings
                  </Button>
                </div>
              </Card>
            </motion.div>
          ...
          <TabsContent key="access" value="access" className="max-w-4xl focus-visible:outline-none">
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -10 }}
              ...
              <Card className="border-2 border-slate-50 shadow-[0_8px_40px_rgba(0,0,0,0.02)] rounded-[32px] overflow-hidden bg-white">
                <CardHeader className="p-12 pb-6 border-b border-slate-50">
                  <div className="flex items-center gap-6 mb-2">
                    ...
                    <div>
                      <CardTitle className="text-3xl font-black tracking-tighter text-slate-800 uppercase leading-none">Login Security</CardTitle>
                      <CardDescription className="font-bold text-slate-400 uppercase text-[10px] tracking-widest mt-2">Control who can access the admin panel.</CardDescription>
                    </div>
                  </div>
                </CardHeader>
                <CardContent className="p-12 pt-10 space-y-12">
                   <div className="flex items-center justify-between p-10 bg-slate-50/50 rounded-[40px] border border-slate-100 shadow-inner">
                    <div className="space-y-1.5">
                      <p className="text-xl font-black text-slate-800 tracking-tight leading-none uppercase italic">Enable Admin Login</p>
                      <p className="text-[10px] text-slate-400 uppercase tracking-widest font-black opacity-60">Switch on/off the login feature for security</p>
                    </div>
                    <Switch 
                   ...
                   <div className="space-y-4">
                    <div className="flex items-center gap-3 mb-2 pl-1">
                      ...
                      <Label className="text-[10px] font-black uppercase tracking-widest text-slate-400">Allowed Email Addresses</Label>
                    </div>
                    <Textarea 
                    ...
                    <div className="flex items-center gap-3 pl-4">
                       ...
                       <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.3em] opacity-40">Enter one email per line</p>
                    </div>
                  </div>
                </CardContent>
                <div className="p-12 pt-0 flex justify-end">
                  <Button onClick={handleSave} className="rounded-2xl h-16 px-12 bg-rose-500 hover:bg-rose-600 text-white font-black text-[12px] uppercase tracking-[0.2em] shadow-xl shadow-rose-500/20 transition-all hover:scale-[1.02]">
                    <Save className="w-5 h-5 mr-3" strokeWidth={3} /> Save Security Settings
                  </Button>
                </div>
              </Card>
            </motion.div>
          ...
          <TabsContent key="database" value="database" className="max-w-4xl focus-visible:outline-none">
            <motion.div
              initial={{ opacity: 0, y: 10 }}
              animate={{ opacity: 1, y: 0 }}
              exit={{ opacity: 0, y: -10 }}
                ...
                <CardHeader className="p-12 pb-6 border-b border-slate-50">
                  <div className="flex justify-between items-start">
                     <div className="flex items-center gap-6 mb-2">
                      ...
                      <div>
                        <CardTitle className="text-3xl font-black tracking-tighter text-slate-800 uppercase leading-none">Database Status</CardTitle>
                        <CardDescription className="font-bold text-slate-400 uppercase text-[10px] tracking-widest mt-2">Check the connection with your data server.</CardDescription>
                      </div>
                    </div>
                    <Button 
                      size="sm" 
                    ...
                    >
                      <RefreshCw className={`w-4 h-4 ${isChecking ? 'animate-spin' : ''}`} /> Check Connection
                    </Button>
                  </div>
                </CardHeader>
                <CardContent className="p-12 pt-10 space-y-12">
                  {dbHealth && (
                    <div className={cn(
                      ...
                      <div className="flex items-center gap-6">
                        ...
                        <div className="space-y-1">
                           <p className="text-[10px] font-black uppercase tracking-[0.3em] opacity-40">Connection Status</p>
                          <p className="text-2xl font-black uppercase tracking-tighter italic">
                            {dbHealth.status === 'connected' ? 'Connected Successfully' : 'Connection Error'}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-10 py-10 border-y border-white/50">
                        <div className="space-y-2">
                           <p className="text-[10px] uppercase font-black text-slate-400 tracking-[0.2em]">Database Server</p>
                           <p className="text-sm font-black font-mono text-slate-700 italic">{dbHealth.config?.host || '--'}</p>
                        </div>
                        <div className="space-y-2">
                           <p className="text-[10px] uppercase font-black text-slate-400 tracking-[0.2em]">DB Name</p>
                           <p className="text-sm font-black font-mono text-slate-700 uppercase">{dbHealth.config?.database || '--'}</p>
                        </div>
                        <div className="space-y-2">
                           <p className="text-[10px] uppercase font-black text-slate-400 tracking-[0.2em]">User Name</p>
                           <p className="text-sm font-black font-mono text-slate-700">{dbHealth.config?.user || '--'}</p>
                        </div>
                        <div className="space-y-2">
                           <p className="text-[10px] uppercase font-black text-slate-400 tracking-[0.2em]">Server Port</p>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                    <div className="space-y-3">
                      <Label htmlFor="db-host" className="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Server Address</Label>
                      <Input 
                        id="db-host" 
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="db-name" className="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Database Name</Label>
                      <Input 
                        id="db-name" 
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="db-user" className="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Login Username</Label>
                      <Input 
                        id="db-user" 
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="db-password" className="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Login Password</Label>
                      <Input 
                        id="db-password" 
                        type="password"
                        placeholder="••••••••" 
                    ...
                    <div className="space-y-3">
                      <Label htmlFor="db-port" className="text-[10px] font-black uppercase tracking-widest text-slate-400 pl-1">Server Port</Label>
                      <Input 
                        id="db-port" 
                        placeholder="3306" 
                        value={dbConfig.port}
                  ...
                  <div className="p-10 rounded-[32px] border-2 bg-slate-50/50 border-slate-100/50 flex gap-10">
                    ...
                    <div className="space-y-2 flex-1">
                      <p className="text-[11px] font-black uppercase tracking-[0.2em] text-slate-800">Security Note</p>
                      <p className="text-xs text-slate-500 leading-relaxed font-bold uppercase tracking-widest opacity-60">
                        Your database details are stored securely. Ensure your server allows connections from the website host: {window.location.hostname}
                      </p>
                    </div>
                  </div>
                </CardContent>
